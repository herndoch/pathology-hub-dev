# Handoff — Hodgkin T/NK-Cell (parts 1–2) Contextual Cloze Anki Builder (v0_1)

Date: 2026-07-13  
Audience: another AI (or human) building the Heme SH **Hodgkin T/NK-Cell (parts 1–2)** contextual-cloze deck  
...
Build an image-grounded, source-aligned contextual cloze Anki deck for **Heme SH Hodgkin T/NK-Cell (parts 1–2)**, following the TNK Lymphomas exemplar and Contextual Cloze SOP v1.1.
...
Closest topical overlap to the TNK exemplar deck; still build from these lecture sources, not by cloning exemplar entities blindly.
...
**Gated chunk warning:** part 1 = **8**, part 2 = **8**; **16 total**. Use as an index only — **not** syllabus/card-scope authority. Always read full transcript, lecture index, and frames.
...
```text
gs://pathology_hub/Heme_SH_Hodgkin_T_NK_Cell_1_package.zip
gs://pathology_hub/Heme_SH_Hodgkin_T_NK_Cell_2_package.zip
```

### Sidecars

```text
gs://pathology_hub/02_normalized/lectures/deck_packages/heme_sh_hodgkin_t_nk_cell_1_v0_1/
gs://pathology_hub/02_normalized/lectures/deck_packages/heme_sh_hodgkin_t_nk_cell_2_v0_1/
```
...
```text
heme_sh_hodgkin_t_nk_cell_deck_project/
├── SOP/
...
```bash
BUNDLE=./heme_sh_hodgkin_t_nk_cell_deck_project
...
gsutil cp "gs://pathology_hub/Heme_SH_Hodgkin_T_NK_Cell_1_package.zip" "$BUNDLE/lecture_1/"
gsutil cp "gs://pathology_hub/Heme_SH_Hodgkin_T_NK_Cell_2_package.zip" "$BUNDLE/lecture_2/"

gsutil -m cp \
  "gs://pathology_hub/02_normalized/lectures/deck_packages/heme_sh_hodgkin_t_nk_cell_1_v0_1/manifest.json" \
  "gs://pathology_hub/02_normalized/lectures/deck_packages/heme_sh_hodgkin_t_nk_cell_1_v0_1/frames.jsonl" \
  "gs://pathology_hub/02_normalized/lectures/deck_packages/heme_sh_hodgkin_t_nk_cell_1_v0_1/segments.jsonl" \
  "gs://pathology_hub/02_normalized/lectures/deck_packages/heme_sh_hodgkin_t_nk_cell_1_v0_1/chunks_indexable.jsonl" \
  "$BUNDLE/lecture_1/"

gsutil -m cp \
  "gs://pathology_hub/02_normalized/lectures/deck_packages/heme_sh_hodgkin_t_nk_cell_2_v0_1/manifest.json" \
  "gs://pathology_hub/02_normalized/lectures/deck_packages/heme_sh_hodgkin_t_nk_cell_2_v0_1/frames.jsonl" \
  "gs://pathology_hub/02_normalized/lectures/deck_packages/heme_sh_hodgkin_t_nk_cell_2_v0_1/segments.jsonl" \
  "gs://pathology_hub/02_normalized/lectures/deck_packages/heme_sh_hodgkin_t_nk_cell_2_v0_1/chunks_indexable.jsonl" \
  "$BUNDLE/lecture_2/"
```
...
```text
Build a contextual-cloze Anki deck for Heme SH Hodgkin T/NK-Cell (parts 1–2).
...
Heme_SH_Hodgkin_T_NK_Cell_1_package.zip, Heme_SH_Hodgkin_T_NK_Cell_2_package.zip
