...
def topic_page_system_prompt() -> str:
    ...
    return (
        ...
        "- '## Key Facts': 3–5 board-style pearls ONLY (prognosis, classic site, hallmark feature, "
        "key ancillary, top DDx pitfall). Do NOT restate content that appears in later sections. "
        "No citations in Key Facts.\n"
        ...
        "sub-bullets for lists. Cite multiple source families when available.\n"
        ...
        "Prefer weaving WHO + PathOutlines + textbooks/journals/videos across the page rather than "
        "WHO-only depth. Never fabricate content or URLs."
    )
